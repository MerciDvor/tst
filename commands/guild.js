...
module.exports = {
    ...
    request(`https://www.rucoyonline.com/guild/${urlname}`, (error, response, html) => {
      if (!error && response.statusCode == 200) {
        ...
        let guildEmbed = new Discord.EmbedBuilder()
          .setTitle(guild)
          .setDescription(guildDescription)
          .addFields(
            {name: "Founded", value: guildFounded, inline: true},
            {name: "Members", value: guildMembers.toString(), inline: true},
            {name: "Leader", value: `[${leader}](https://www.rucoyonline.com/characters/${leader.replaceAll(" ", "%20")})`, inline: true},
          )
          .setColor("#21ba45")
