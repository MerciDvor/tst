    ...
    request(`https://www.rucoyonline.com/characters/${char}`, (error, response, html) => {
      if (!error && response.statusCode == 200) {
        ...
        if (charHeading.text().includes("Game Master")) {
          var charEmbed = new Discord.EmbedBuilder()
            .setTitle(character.name)
            .setURL(`https://www.rucoyonline.com/characters/${urlname}`)
            .setColor("#ffff00")
            .addFields(
          		{ name: "Guild", value: `[${character.guild}](https://www.rucoyonline.com/guild/${character.guild.replaceAll(" ","%20")})` },
          		{ name: "Born", value: character.born },
          	);
          ...
          var charEmbed = new Discord.EmbedBuilder()
            ...
            .addFields(
              ...
              { name: "Last Online", value: character.last_online, inline: true },
              { name: "Born", value: character.born, inline: true },
          	);
        } else {
          var charEmbed = new Discord.EmbedBuilder()
            .setTitle(character.name)
